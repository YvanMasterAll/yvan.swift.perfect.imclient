...
func PTRLocalize(_ string:String)->String{
    ...
    if let url = bundle.url(forResource: "RefreshKit", withExtension: "bundle") {
        if let bundle = Bundle(url: url) {
            return NSLocalizedString(string, tableName: "Localize", bundle: bundle, value: "", comment: "")
        }
    }
    return ""
}
